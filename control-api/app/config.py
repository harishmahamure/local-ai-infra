...
COMFY_LTX_URL = os.environ.get("COMFY_LTX_URL", f"http://{LAN_IP}:{COMFY_LTX_PORT}")
COMFYUI_MODELS = Path(os.environ.get("COMFYUI_MODELS", HOME / "model_backup" / "comfyui"))

VALID_PROFILES = {"llama-fast", "gemma", "comfyui", "comfy-ltx"}
COMFY_PROFILES = {"comfyui", "comfy-ltx"}
